...
const formSchema = z.object({
    ...
    confirmedPassword: z.string().min(1,{message:"Password is required"}),
})
                                ...
                                <div className="grid gap-3">
                                    ...
                                    render={({field})=> (
                                        <FormItem>
                                            ...
                                            <FormControl><Input type="text" placeholder="your name" {...field}></Input></FormControl>
                                ...
                                <div className="grid gap-3">
                                    ...
                                    render={({field})=> (
                                        <FormItem>
                                            ...
                                            <FormControl><Input type="email" placeholder="example@xyz.com" {...field}></Input></FormControl>
                                            <FormMessage></FormMessage>
                                        </FormItem>
                                    )}
                                    />
                                ...
                                <div className="grid gap-3">
                                    ...
                                    render={({field})=> (
                                        <FormItem>
                                            ...
                                            <FormControl><Input type="password" placeholder="********" {...field}></Input></FormControl>
                                            <FormMessage></FormMessage>
                                        </FormItem>
                                    )}
                                    />
